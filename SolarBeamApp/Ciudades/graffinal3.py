...
def main(tax):
    im3 = Image.new("RGB", (2500, 1800), (245,245,185,255)).convert('RGBA')
    im4 = Image.new("RGB", (2500, 1950), (245,245,185,255)).convert('RGBA')

    draw = ImageDraw.Draw(im3)
    fnt = ImageFont.truetype('/home/Shirohige/SolarBeam/Ciudades/static/font/Ubuntu-Bold.ttf', 60)
    ...
    im4.paste(im3,(0,75))
    im4.save("/home/Shirohige/SolarBeam/Ciudades/static/imagenes/grafica1.jpg")